...
Also you can use `implements` with object type aliases for [Class Types](/docs/class-types) to tell Hegel that you want that a class to match an "protocol".
...
**Warning**: Note, that your object type which should act like interface should be a soft object type.