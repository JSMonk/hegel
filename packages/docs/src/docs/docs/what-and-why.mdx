...
But, we need to answer at this question differently for different audience. So, choose list item which discribe your experience:
...
//Вообще выпилил бы этот пункт с популярностью, не думаю, что это привлечет юзеров
...
//Ну как я и говорил выше, тоже убрал бы этот пункт
