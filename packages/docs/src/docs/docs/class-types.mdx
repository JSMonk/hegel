...
You can define class field inside body of class.
...
**Info** If you already familiar with TypeScript. Hegel is not provide an ccessibility modifiers like `public`, `private` or `protected`. 
