...
Or install locally only for your project:
...
> Hegel was developed for current LTS version of [Node.js (12.16.1)](https://nodejs.org/en/). So, you need to have at least version 12.
