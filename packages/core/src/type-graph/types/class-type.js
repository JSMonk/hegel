...
export class $Class extends GenericType {
  ...
  constructor(_, meta = {}) {
    ...
    super("$Class", meta, [TypeVar.term("target", { parent })], parent, null);
  }
  ...
  applyGeneric(parameters, loc) {
    ...
    if (!(realTarget instanceof ObjectType && realTarget.classType !== null)) {
      throw new HegelError(
        "Cannot apply $Class to non-class instance type",
        loc
      );
    }
